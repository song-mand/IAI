...
Main ideas:
- high precision copy/protect rules
- Spanish cyber-writing candidates: ke/kiero/aki, xk/muxo, wapa/weno, repeated letters
- accent omission candidates
- abbreviation candidates
- MFR/key lookup candidates
...
# High precision abbreviation table. Values use underscores for multi-token normalizations.
ABBREVIATIONS = {
    "bn": ["bien"],
    "bno": ["bueno"],
    "bna": ["buena"],
