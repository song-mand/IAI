...
from train_es_change_detector import extract_features, is_protected_token, LANG
...
def build_hybrid_predictions(
    ...
    for raw_words in tqdm(raw_sents, desc="hybrid"):
...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default="./final_model_eval_es")
    parser.add_argument("--threshold", type=float, default=0.5)
    parser.add_argument("--mode", choices=["detector_mfr_byt5", "detector_byt5", "detector_mfr_only"], default="detector_mfr_byt5")
    parser.add_argument("--mfr_min_conf", type=float, default=0.60)
