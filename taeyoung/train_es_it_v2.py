...
- Korean is intentionally NOT trained here in v2.
- In v2, Korean is handled conservatively in the submission code with MFR + safe rules.
...
def train_one_language(lang):
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir=f"./models/byt5-{lang}-v2",
        save_strategy="no",
